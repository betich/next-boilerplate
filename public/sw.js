!(function () {
  ...
  !(function () {
    ...
    async function g(e, s) {
      ...
      if (n !== self.location.origin) throw new t("cross-origin-copy-response", { origin: n })
      const a = e.clone(),
        r = { headers: new Headers(a.headers), status: a.status, statusText: a.statusText },
        i = s ? s(r) : r,
        o = (function () {
          if (void 0 === h) {
    ...
    function E(e) {
      return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype
        ? (
            m ||
            (m = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])
          ).includes(e)
          ? function (...t) {
              return e.apply(k(this), t), T(y.get(this))
            }
          : function (...t) {
              return T(e.apply(k(this), t))
            }
        : function (t, ...s) {
            const n = e.call(k(this), t, ...s)
            return v.set(n, t.sort ? t.sort() : [t]), T(n)
          }
    }
    function C(e) {
      return "function" === typeof e
        ...
        : (e instanceof IDBTransaction &&
          ...
          (t = e),
          (w || (w = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((e) => t instanceof e)
            ? new Proxy(e, R)
            : e)
      var t
    }
    ...
    function D(e, t) {
      ...
      const s = t.replace(/FromIndex$/, ""),
        n = t !== s,
        a = q.includes(s)
      if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || (!a && !L.includes(s))) return
    ...
    R = ((e) => ({ ...e, get: (t, s, n) => D(t, s) || e.get(t, s, n), has: (t, s) => !!D(t, s) || e.has(t, s) }))(R)
    s(661)
    ...
    class P {
        ...
        this._upgradeDb(e),
          this._cacheName &&
            (function (e, { blocked: t } = {}) {
              ...
              t && s.addEventListener("blocked", (e) => t(e.oldVersion, e)), T(s).then(() => {})
            })(this._cacheName)
      }
      async setTimestamp(e, t) {
        const s = { url: (e = S(e)), timestamp: t, cacheName: this._cacheName, id: this._getId(e) },
          n = (await this.getDb()).transaction(N, "readwrite", { durability: "relaxed" })
      ...
      async expireEntries(e, t) {
        ...
        let n = await s.transaction(N).store.index("timestamp").openCursor(null, "prev")
        const a = []
        let r = 0
        for (; n; ) {
          const s = n.value
      ...
      async getDb() {
        return (
          this._db ||
            (this._db = await (function (e, t, { blocked: s, upgrade: n, blocking: a, terminated: r } = {}) {
              const i = indexedDB.open(e, t),
                o = T(i)
              return (
                n &&
                  i.addEventListener("upgradeneeded", (e) => {
                    n(T(i.result), e.oldVersion, e.newVersion, T(i.transaction), e)
                  }),
            ...
            })("workbox-expiration", 1, { upgrade: this._upgradeDbAndDeleteOldDbs.bind(this) })),
          this._db
        )
      }
    }
    class I {
      ...
      async expireEntries() {
        ...
        ;(this._isRunning = !1), this._rerunRequested && ((this._rerunRequested = !1), l(this.expireEntries()))
      }
    ...
    class A {
      ...
      _getCacheExpiration(e) {
        ...
        return s || ((s = new I(e, this._config)), this._cacheExpirations.set(e, s)), s
      }
    ...
    class O {
      ...
      async fetch(e) {
        ...
        try {
          for (const e of this.iterateCallbacks("requestWillFetch")) n = await e({ request: n.clone(), event: s })
        } catch (i) {
          if (i instanceof Error) throw new t("plugin-error-request-will-fetch", { thrownErrorMessage: i.message })
        }
        const r = n.clone()
        try {
          let e
          e = await fetch(n, "navigate" === n.mode ? void 0 : this._strategy.fetchOptions)
          for (const t of this.iterateCallbacks("fetchDidSucceed")) e = await t({ event: s, request: r, response: e })
          return e
        } catch (o) {
          throw (
            (a &&
      ...
      async cacheMatch(e) {
        ...
        for (const o of this.iterateCallbacks("cachedResponseWillBeUsed"))
          s = (await o({ cacheName: n, matchOptions: a, cachedResponse: s, request: r, event: this.event })) || void 0
        return s
      }
      async cachePut(e, s) {
        const a = M(e)
        ...
        for (const t of this.iterateCallbacks("cacheDidUpdate"))
          await t({ cacheName: o, oldResponse: p, newResponse: i.clone(), request: r, event: this.event })
        return !0
      }
      async getCacheKey(e, t) {
        ...
        if (!this._cacheKeys[s]) {
          ...
          for (const e of this.iterateCallbacks("cacheKeyWillBeUsed"))
            n = M(await e({ mode: t, request: n, event: this.event, params: this.params }))
          this._cacheKeys[s] = n
        }
      ...
      *iterateCallbacks(e) {
      ...
      async _ensureResponseSafeToCache(e) {
        ...
        for (const n of this.iterateCallbacks("cacheWillUpdate"))
          if (((t = (await n({ request: this.request, response: t, event: this.event })) || void 0), (s = !0), !t))
            break
    ...
    class K {
      ...
      handleAll(e) {
        ...
        const t = e.event,
          ...
          a = new O(this, { event: t, request: s, params: n }),
      ...
      async _getResponse(e, s, n) {
        ...
        try {
          if (((a = await this._handle(s, e)), !a || "error" === a.type)) throw new t("no-response", { url: s.url })
        } catch (r) {
        ...
        for (const t of e.iterateCallbacks("handlerWillRespond")) a = await t({ event: n, request: s, response: a })
        return a
      }
      async _awaitComplete(e, t, s, n) {
        ...
        try {
          await t.runCallbacks("handlerDidRespond", { event: n, request: s, response: a }), await t.doneWaiting()
        } catch (i) {
          i instanceof Error && (r = i)
        }
        if (
          (await t.runCallbacks("handlerDidComplete", { event: n, request: s, response: a, error: r }), t.destroy(), r)
        )
          throw r
      }
    }
    const W = { cacheWillUpdate: async ({ response: e }) => (200 === e.status || 0 === e.status ? e : null) }
    class j extends K {
      constructor(e = {}) {
        super(e),
          this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(W),
      ...
      async _handle(e, s) {
        ...
        if (this._networkTimeoutSeconds) {
          const { id: t, promise: i } = this._getTimeoutPromise({ request: e, logs: n, handler: s })
          ;(r = t), a.push(i)
        }
        const i = this._getNetworkPromise({ timeoutId: r, request: e, logs: n, handler: s })
        a.push(i)
    ...
    class B extends K {
      constructor(e = {}) {
        super(e), this.plugins.some((e) => "cacheWillUpdate" in e) || this.plugins.unshift(W)
      }
      async _handle(e, s) {
    ...
    s(600)
    const H = (e) => (e && "object" === typeof e ? e : { handle: e })
    class F {
    ...
    class G {
      ...
      handleRequest({ request: e, event: t }) {
        ...
        const n = s.origin === location.origin,
          { params: a, route: r } = this.findMatchingRoute({ event: t, request: e, sameOrigin: n, url: s })
        let i = r && r.handler
        const o = e.method
        if ((!i && this._defaultHandlerMap.has(o) && (i = this._defaultHandlerMap.get(o)), !i)) return void 0
        let c
        try {
          c = i.handle({ url: s, request: e, event: t, params: a })
        } catch (l) {
          c = Promise.reject(l)
        }
    ...
    let Q
    const V = () => (Q || ((Q = new G()), Q.addFetchListener(), Q.addCacheListener()), Q)
    function J(e, s, n) {
      let a
      if ("string" === typeof e) {
        const t = new URL(e, location.href)
        0
        a = new F(({ url: e }) => e.href === t.href, s, n)
      } else if (e instanceof RegExp) a = new $(e, s, n)
      else if ("function" === typeof e) a = new F(e, s, n)
      else {
        if (!(e instanceof F))
    ...
    class Y {
      constructor({ precacheController: e }) {
        ;(this.cacheKeyWillBeUsed = async ({ request: e, params: t }) => {
          const s =
            (null === t || void 0 === t ? void 0 : t.cacheKey) || this._precacheController.getCacheKeyForURL(e.url)
    ...
    class Z extends K {
      ...
      async _handleFetch(e, s) {
        ...
        if (!this._fallbackToNetwork) throw new t("missing-precache-entry", { cacheName: this.cacheName, url: e.url })
        {
          ...
          const t = a.integrity,
            ...
            i = !r || r === t
          if (
            ((n = await s.fetch(new Request(e, { integrity: "no-cors" !== e.mode ? r || t : void 0 }))),
            t && i && "no-cors" !== e.mode)
          ) {
      ...
      async _handleInstall(e, s) {
        ...
        if (!(await s.cachePut(e, n.clone()))) throw new t("bad-precaching-response", { url: e.url, status: n.status })
        return n
      }
      _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (const [s, n] of this.plugins.entries())
          n !== Z.copyRedirectedCacheableResponsesPlugin &&
            (n === Z.defaultPrecacheCacheabilityPlugin && (e = s), n.cacheWillUpdate && t++)
        0 === t
    ...
    class ee {
      ...
      install(e) {
        return p(e, async () => {
          ...
          for (const [a, r] of this._urlsToCacheKeys) {
            ...
            await Promise.all(this.strategy.handleAll({ params: { cacheKey: r }, request: n, event: e }))
          }
      ...
      createHandlerBoundToURL(e) {
        ...
        return (t) => (
          (t.request = new Request(e)), (t.params = Object.assign({ cacheKey: s }, t.params)), this.strategy.handle(t)
        )
      }
    }
    let te
    const se = () => (te || (te = new ee()), te)
    class ne extends F {
      constructor(e, t) {
        super(({ request: s }) => {
    ...
    function ae(e) {
      return se().matchPrecache(e)
    }
    self.skipWaiting(), self.addEventListener("activate", () => self.clients.claim())
    var re,
      ie,
      oe = [
        { revision: "b3ca2e9a9574e304", url: "/_next/static/chunks/framework-b3ca2e9a9574e304.js" },
        { revision: "22409175f1ddefae", url: "/_next/static/chunks/main-22409175f1ddefae.js" },
        { revision: "1daf25ec71704dfc", url: "/_next/static/chunks/pages/_app-1daf25ec71704dfc.js" },
        { revision: "b5a83d78c78e1f32", url: "/_next/static/chunks/pages/_error-b5a83d78c78e1f32.js" },
        { revision: "73edc5e7be3137a6", url: "/_next/static/chunks/pages/index-73edc5e7be3137a6.js" },
        { revision: "837c0df77fd5009c9e46d446188ecfd0", url: "/_next/static/chunks/polyfills-c67a75d1b6f99dc8.js" },
        { revision: "69bfa6990bb9e155", url: "/_next/static/chunks/webpack-69bfa6990bb9e155.js" },
        { revision: "edeb8d03bd47e80a", url: "/_next/static/css/edeb8d03bd47e80a.css" },
        { revision: "c9fdb9d5fe5459f9e874fca9e68255bf", url: "/_next/static/dQVoIHaIfyOiMVw214Tio/_buildManifest.js" },
        { revision: "b6652df95db52feb4daf4eca35380933", url: "/_next/static/dQVoIHaIfyOiMVw214Tio/_ssgManifest.js" },
        { revision: "958a0b97", url: "/_next/static/media/Inter-italic.var.958a0b97.woff2" },
        { revision: "b2129c00", url: "/_next/static/media/Inter-roman.var.b2129c00.woff2" },
        { revision: "fbc496e4", url: "/_next/static/media/Noto-Sans-Thai.var.fbc496e4.woff2" },
        { revision: "044c9db6d2367a9cd4c0a4a8fd318ba9", url: "/android-chrome-192x192.png" },
        { revision: "7c91718d7c0242a1e279546dcf3c25db", url: "/android-chrome-512x512.png" },
        { revision: "8bc6eb1895881346a00b0ccebdace18c", url: "/apple-touch-icon.png" },
        { revision: "a911d80c83774569a4b06c7bbe92ee9b", url: "/favicon-16x16.png" },
        { revision: "8142652fe9165a194dea4434343997de", url: "/favicon-32x32.png" },
        { revision: "031b139aa2a7c093e474c82a03df4679", url: "/favicon.ico" },
        { revision: "ef42f1e19b02ec28ba6a09d531d0ec19", url: "/site.webmanifest" },
        { revision: "134fadb58343d8bcde6f655915b498ab", url: "/sw.js" },
      ]
    oe.push({ url: "/fallback", revision: "1234567890" }),
      (function (e) {
        se().precache(e)
      })(oe),
      (function (e) {
      ...
      J(
        ...
        new j({
          cacheName: "start-url",
          plugins: [new A({ maxEntries: 1, maxAgeSeconds: 86400, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
        ...
        new (class extends K {
          ...
          plugins: [new A({ maxEntries: 4, maxAgeSeconds: 31536e3, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
        ...
        new B({
          ...
          plugins: [new A({ maxEntries: 4, maxAgeSeconds: 604800, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
        ...
        new (class extends K {
          ...
          plugins: [new A({ maxEntries: 64, maxAgeSeconds: 86400, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
        ...
        new B({
          ...
          plugins: [new A({ maxEntries: 32, maxAgeSeconds: 86400, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
      ...
      J(
        ...
        new j({
          ...
          plugins: [new A({ maxEntries: 16, maxAgeSeconds: 86400, purgeOnQuotaError: !0 })],
        }),
        "GET"
      ),
      J(
      ...
      (function (e) {
        ...
        switch (e.event.request.destination) {
          case "document":
            return ae("/fallback")
          case "image":
            return ae("/static/images/fallback.png")
          default:
